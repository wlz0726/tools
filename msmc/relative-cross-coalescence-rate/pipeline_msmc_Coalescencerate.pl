...
use strict;
use warnings;
my $bin='/home/wanglizhong/project/01.cattle.CATwiwR/05.MSMC.2/Coalescencerate/bin';#'/home/wanglizhong/project/01.cattle.CATwiwR/1608.MSMC.cattle.Pipeline/Coalescencerate';
use FindBin qw($Bin);
use Getopt::Long;
my $help =<<qq;
...
1:Memory for qsub 
  ...
  3)for step3, it depends on the sample size, example 70G for 4 individuals(8 haplotypes),25G for 2individuals (4 haplotype);
