...
my $l2=`echo 01.cattle.CATwiwR`;
my $l3=`grep ifshk4/BC_COM_P5 ~/bin/check.disk.storage.pl.tmp`;
...
my $l8=`echo 04.zangyi.F13FTSNWKF2248_HUMmuzR`;
my $l9=`grep ifshk7/BC_RES ~/bin/check.disk.storage.pl.tmp`;
